...
namespace HRProject.Areas.Settings.Controllers
{
    ...
    public class PositionController : AbstractController
    {
        ...
        public PositionController(IServiceProvider provider) : base(provider)
        {
            _service = Resolve<PositionService>();
        }
        [HttpPost]
        [Route("form")]
        public IActionResult Form(PositionViewModel viewModel)
        {
