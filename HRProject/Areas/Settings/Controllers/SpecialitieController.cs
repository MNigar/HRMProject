...
{
    [Area("Settings")]
    [Route("Settings/Specialitie")]
    public class SpecialitieController : AbstractController
    {
        public static string Name = "Specialitie";
        private readonly SpecialitieService _service;
        public SpecialitieController(IServiceProvider provider) : base(provider)
        {
            _service = Resolve<SpecialitieService>();
        }
        [HttpPost]
        [Route("form")]
        public IActionResult Form(SpecialitieViewModel viewModel)
        {
