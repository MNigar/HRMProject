...
namespace HRProject.Areas.Settings.Controllers
{
    ...
    public class DocumentTypeController : AbstractController
    {
        public static string Name = "DocumentType";
        private readonly DocumentTypeService _service;
        public DocumentTypeController(IServiceProvider provider) : base(provider)
        {
            _service = Resolve<DocumentTypeService>();
        }
        [HttpPost]
        [Route("form")]
        public IActionResult Form(DocumentTypeViewModel viewModel)
        {
