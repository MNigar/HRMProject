...
{
    [Area("Settings")]
    [Route("Settings/DismissalType")]
    public class DismissalTypeController : AbstractController
    {
        public static string Name = "DismissalType";
        private readonly DismissalTypesService _service;
        public DismissalTypeController(IServiceProvider provider) : base(provider)
        {
            _service = Resolve<DismissalTypesService>();
        }
        [HttpPost]
        [Route("form")]
        public IActionResult Form(DismissalTypeViewModel viewModel)
        {
