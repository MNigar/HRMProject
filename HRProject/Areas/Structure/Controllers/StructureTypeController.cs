...
namespace HRProject.Areas.Structure.Controllers
{
        ...
        [Area("Structure")]
        [Route("Structure/StructureType")]
        public class StructureTypeController : AbstractController
        {
            public static string Name = "StructureType";
            private readonly StructureTypeService _service;
            public StructureTypeController(IServiceProvider provider) : base(provider)
            {
                _service = Resolve<StructureTypeService>();
            }
            [HttpPost]
            [Route("form")]
            public IActionResult Form(StructureTypeViewModel viewModel)
            {
