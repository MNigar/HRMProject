...
{
    [Area("Settings")]
    [Route("Settings/EducationLevel")]
    public class EducationLevelController : AbstractController
    {
        public static string Name = "EducationLevel";
        private readonly EducationLevelService _service;
        public EducationLevelController(IServiceProvider provider) : base(provider)
        {
            _service = Resolve<EducationLevelService>();
        }
        [HttpPost]
        [Route("form")]
        public IActionResult Form(EducationLevelViewModel viewModel)
        {
